...
//                  color: AppTheme.nearlyDarkGeen.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      AppTheme.nearlyDarkGeen.withOpacity(0.2),
                      AppTheme.nearlyDarkGeen.withOpacity(0.5)],
             ...
             ClipPath(
              child:  Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [AppTheme.nearlyDarkBlue.withOpacity(0.7), AppTheme.nearlyDarkGeen],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
                  borderRadius: BorderRadius.only(
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/images/Dashboard/bottle.png"),
                ),
              ],
            )
          ],

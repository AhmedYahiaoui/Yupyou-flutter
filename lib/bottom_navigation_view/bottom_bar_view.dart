                ...
                child: Column(
                  children: <Widget>[
                    SizedBox(
                      ...
                      child: Padding(
                        padding:
                            const EdgeInsets.only(left: 8, right: 8, top: 14, bottom: 14),
                        child: Row(
                          children: <Widget>[
...
class MyDialogState extends State<MyDialog> {
  ...
  void _doSomething() async {
    if (_key.currentState.validate()) {
      databaseHelper.AddDevice(
          emailController.text, IDController.text, _selectedId);
    }
  }
                    ...
                    child: Column(
                        children: <Widget>[
                          ...
                          DropdownButton<String>(
                            ...
                            items: <String>['humun', 'animal', 'car', 'object'].map((String value) {
